...
<?php
echo "<a href='https://aarmindonesia.org/wikabpm/highchart/live%20Version/group_Collum_CI_Nilai/download.php?year=$pilih&month=$pilih_2&id=$pilih_3&kl=$kl'><i class='fa fa-download' style='padding-left:30px; padding-right=10px; font-size:20px;'></i></a>";
?></span>
		  <table class="tbl-qa">
		  <thead>
		    <tr>
...
?>
                   <tr class="table-row">
                	...
                	<td><?php echo $format_indonesia = number_format ($json_data[$i]['Tactic'], 0, ',', '.'); ?></td>
