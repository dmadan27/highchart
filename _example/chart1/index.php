	...
	<body>
		<div id="head4" style="padding:2px 0px 2px 0px;font-size:20px;">
			<table border="0" style="width:100%">
				<tr>
					<td style="width:90;color:#FFF;">&nbsp;&nbsp;OK Terendah dan Terkontrak per Departement (Dalam Trilyun)</td>
					<td style="width:10%;color:#FFF;"><span id="dem" onClick="backon();"><i class="fa fa-bar-chart-o"></i></span></td>
				</tr>
			</table>
		</div>
		<div id="container" >
