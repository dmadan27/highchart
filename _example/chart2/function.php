...
<span id="tot" style="font-size:14px;color:#6483c3;padding:10px;float:right">Total JO : <?php echo $format_indonesia = number_format ($total_3, 0, ',', '.'); ?>
<?php
echo "<a href='https://aarmindonesia.org/wikabpm/highchart/live%20Version/group_donat/download.php?dop2=$dop2&year=$pilih&month=$pilih_2&id=$pilih_3'><i class='fa fa-download' style='padding-left:30px; padding-right=10px; font-size:20px;'></i></a>";
?></span>
<table class="tbl-qa">
		  <thead>
			  <tr>
...
<span id="tot" style="font-size:14px;color:#6483c3;padding:10px;float:right">Total Non JO : <?php echo $format_indonesia = number_format ($total_2, 0, ',', '.'); ?>
<?php
echo "<a href='https://aarmindonesia.org/wikabpm/highchart/live%20Version/group_donat/download.php?dop2=$dop2&year=$pilih&month=$pilih_2&id=$pilih_3'><i class='fa fa-download' style='padding-left:30px; padding-right=10px; font-size:20px;'></i></a>";
?></span>
<table class="tbl-qa">
...
<span id="tot" style="font-size:14px;color:#6483c3;padding:10px;float:right">Total JO : <?php echo $format_indonesia = number_format ($total_3_B, 0, ',', '.'); ?>
<?php
echo "<a href='https://aarmindonesia.org/wikabpm/highchart/live%20Version/group_donat/download.php?dop2=$dop2&year=$pilih&month=$pilih_2&id=$pilih_3'><i class='fa fa-download' style='padding-left:30px; padding-right=10px; font-size:20px;'></i></a>";
?></span>
<table class="tbl-qa">
...
<span id="tot" style="font-size:14px;color:#6483c3;padding:10px;float:right">Total Non JO : <?php echo $format_indonesia = number_format ($total_2_B, 0, ',', '.'); ?>
<?php
echo "<a href='https://aarmindonesia.org/wikabpm/highchart/live%20Version/group_donat/download.php?dop2=$dop2&year=$pilih&month=$pilih_2&id=$pilih_3'><i class='fa fa-download' style='padding-left:30px; padding-right=10px; font-size:20px;'></i></a>";
?></span>
<table class="tbl-qa">
...
<span id="tot" style="font-size:14px;color:#6483c3;padding:10px;float:right">Total JO : <?php echo $format_indonesia = number_format ($total_3_C, 0, ',', '.'); ?>
<?php
echo "<a href='https://aarmindonesia.org/wikabpm/highchart/live%20Version/group_donat/download.php?dop2=$dop2&year=$pilih&month=$pilih_2&id=$pilih_3'><i class='fa fa-download' style='padding-left:30px; padding-right=10px; font-size:20px;'></i></a>";
?></span>
<table class="tbl-qa">
...
<span id="tot" style="font-size:14px;color:#6483c3;padding:10px;float:right">Total Non JO : <?php echo $format_indonesia = number_format ($total_2_C, 0, ',', '.'); ?>
<?php
echo "<a href='https://aarmindonesia.org/wikabpm/highchart/live%20Version/group_donat/download.php?dop2=$dop2&year=$pilih&month=$pilih_2&id=$pilih_3'><i class='fa fa-download' style='padding-left:30px; padding-right=10px; font-size:20px;'></i></a>";
?></span>
<table class="tbl-qa">
