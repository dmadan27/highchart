...
<body>
	...
	<table border="0" style="width:100%"><tr><td style="width:90;color:#FFF;%">
		&nbsp;&nbsp;OK Terendah dan Terkontrak per Sumber Dana (Dalam Trilyun)</td><td style="width:10%;color:#FFF;">
		<span id="dem" onClick="backon();"><i class="fa fa-bar-chart-o"></i></span></td></tr>
	</table>
	</div>
	<div id="container" >
